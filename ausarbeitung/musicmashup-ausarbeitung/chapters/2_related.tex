...
\verb http://dbpedia.org/resource/Led_Zeppelin (S) http://www.w3.org/1999/02/22-rdf-syntax-ns\#type (P) http://dbpedia.org/ontology/Band (O)
(Q3)
...
\verb dbpedia:Led_Zeppelin (S) rdf:type (P) dbpedia-owl:Band (O)
